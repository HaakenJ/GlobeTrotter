...
INSERT INTO `HOTEL_BRAND` VALUES (1,'Marriott',2),(2,'Best Western',3),(3,'Choice Hotels',4),(4,'Four Seasons Hotels and Resorts',5),(5,'Hilton',2),(6,'Hyatt Hotels',3),(7,'MGM Resorts',4),(8,'Walt Disney Resorts',5),(9,'Holiday Inn',2),(10,'Westin',3),(11,'Embassy Suites',4),(12,'Shangri-La',5),(13,'Hotel Ibis',2),(14,'Novotel',3),(15,'XIV',4),(16,'Taj',5),(17,'Mandarin Oriental',2),(18,'Copthome Hotels',3),(19,'Jinjiang',4),(20,'Radisson Blu',5),(21,'Waldorf Asotria',2);
...
--
-- Temporary view structure for view `TOP3_RATEDESTFOODTYPE`
--

DROP TABLE IF EXISTS `TOP3_RATEDESTFOODTYPE`;
/*!50001 DROP VIEW IF EXISTS `TOP3_RATEDESTFOODTYPE`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `TOP3_RATEDESTFOODTYPE` AS SELECT 
 1 AS `destination_id`,
 1 AS `destination`,
 1 AS `food_name`,
 1 AS `numbers_of_times_recommended`*/;
...
BEGIN
INSERT INTO MEMBER (member_id, member_fname, member_lname, member_city, member_country)
VALUES (m_id, m_fname, m_lname, m_city, m_country); 
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `getAllRatings` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `getAllRatings`(
)
BEGIN
SELECT 
...
ORDER BY Destination, Hotel, Airline, Highlight;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateHotel` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `updateHotel`()
BEGIN
	DECLARE i INT;
    DECLARE hotel_str INT;
    ...
    loop_label: LOOP
        ...
        UPDATE HOTEL_BRAND
        SET hotel_stars = hotel_str
        WHERE hotel_id = i;
        
        SET i = i + 1;
        SET hotel_str = hotel_str + 1;
	END LOOP;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
--
-- Final view structure for view `TOP3_RATEDESTFOODTYPE`
--
...
/*!50001 VIEW `TOP3_RATEDESTFOODTYPE` AS select `RATING`.`dest_id` AS `destination_id`,`DESTINATION`.`dest_name` AS `destination`,`FOOD_TYPE`.`food_name` AS `food_name`,count(`RATING`.`dest_id`) AS `numbers_of_times_recommended` from ((`DESTINATION` join `RATING` on((`RATING`.`dest_id` = `DESTINATION`.`dest_id`))) join `FOOD_TYPE` on((`DESTINATION`.`food_id` = `FOOD_TYPE`.`food_id`))) group by `RATING`.`dest_id` order by `numbers_of_times_recommended` desc limit 5 */;
...
-- Dump completed on 2020-10-30 16:38:20
